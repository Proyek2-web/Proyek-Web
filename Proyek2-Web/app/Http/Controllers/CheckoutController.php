...
class CheckoutController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = DB::table('carts')
            ...
            ->select('carts.id as id','carts.catatan as catatan', 'carts.qty as qty', 'products.id as product_id', 'products.nama as nama', 'products.featured_image as featured_image','products.berat as berat', 'products.harga as harga', 'products.status_produk as status_produk', 'categories.name as category_name','carts.status as status')
            ->get();
            $total_berat = 0;
            $s= 0;
            foreach ($data as $d) {
