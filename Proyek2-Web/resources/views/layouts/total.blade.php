            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="wrap justify-content-center">
                        ...
                        <div class="detail"> <span class="d-block summery">Silahkan lakukan pembayaran sesuai intruksi di
                                bawah ini</span> </div>
                        <hr style="width: 100%">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body" style="background-color: transparent">
                                            @foreach ($ts->steps as $s)
                                                <li style="list-style-type:none">{{ $loop->iteration }}.
                                                    {!! $s !!}</li>
                                            @endforeach
                                        </div>
                                    </div>
                ...
                <div class="col-md-5">
                    <div class="wrap-nota p-4" style="background-color: rgb(221, 220, 219)">
                        <h4 style="font-family: Marck Script;" class=" theme-color mb-5">Thanks for your order !</h4> <span
                            class="theme-color">Ringkasan Pembayaran</span>
                        <div class="mb-3">
                            <hr class="new1">
                        </div>
                        @foreach ($data as $d)
                        ...
                        @if ($status)
                            <form action="#">
                                <button class="btn btn-success" type="submit">Sudah Diterima?</button>
                            </form>
                        @endif
                    </div>
                </div>
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-dark"><small
                                            ...
                                            : {{ $d->qty }}</small></p>
                                    <p class="card-text text-dark"><small
                                            style="border-radius: 5px; padding-inline: 15px; padding-block: 5px; background-color: #bcbec2b9">Sub
                                            Total
