                    ...
                    <div class="wrap justify-content-center">
                                    ...
                                    @if ($order->status == 'PAID')
                                        ...
                                        <div class="wrap-track d-flex justify-content-center mt-3">
                                            ...
                                            <a href="https://www.tiki.id/id/tracking" style="text-decoration: none">
                                                <div class="card text-center text-dark p-3"
                                                    style="margin-inline: 10px; background-color: rgba(169, 169, 170, 0.514)"">
                                                                    <img src="
                                                    https://www.tikibanjarmasin.com/images/Logo-TIKI.png" width="203"
                                                    alt="">
                                                    <p>Tracking JNE</p>
                                                </div>
                                            </a>
                                            <a href="https://www.posindonesia.co.id/id/tracking"
                        ...
                        @else
                            @if ($order->status == 'UNPAID')
                                <div class="first d-flex justify-content-between align-items-center mb-3">
                                    <div class="info"> <span class="d-block name">Terima Kasih,
                            ...
                            @else
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($order->order_notes != null)
                                        <div class="detail"> <span class="d-block summery text-center"
                                                style="font-size: 1.2rem">Transaksi Selesai</span>
                                        </div>
                                    @elseif($order->order_notes == null && $order->resi != null)
                                        <div class="detail"> <span class="d-block summery text-center"
                                                style="font-size: 1.2rem">Barang Sedang Dikirim</span>
                                        </div>
                                    @elseif($order->order_notes == null && $order->resi == null)
                                        <div class="detail"> <span class="d-block summery text-center"
                                                style="font-size: 1.2rem">Pesanan Di Proses</span>
                                        </div>
                                    @endif
                        ...
                        @foreach ($data as $d)
                            <div class="card mb-3 border-0"
                                ...
                                <div class="row g-0 align-items-center ">
                                    <div class="col-md-4">
                                        <img src="{{ asset('/storage/' . $d->featured_image) }}" class="img-fluid"
