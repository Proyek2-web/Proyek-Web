                    ...
                    <div class="first d-flex justify-content-between align-items-center mb-3">
                        <div class="info"> <span class="d-block name">Pesananmu dalam pengiriman</span>
                            ...
                            <div class="input-group mb-3 ">
                                ...
                                <button onclick="copyResi()" class="input-group-text"
                                    id="basic-addon2" style="font-size: 0.9rem">Copy No. Resi</i></button>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="wrap-track d-flex justify-content-center mt-3" >
                                <a href="https://www.jne.co.id/id/tracking/trace" style="text-decoration: none">
                                    <div class="card text-center text-dark p-3" style="margin-inline: 10px; background-color: rgba(169, 169, 170, 0.514); font-weight: bold">
                                        <img src="https://4.bp.blogspot.com/-yKgaARxg8ds/Wg0ZLKrbnpI/AAAAAAAAE9o/lJ3vLsqmUE0k4OPDMd99zynr9I1qVj3ewCLcBGAs/s1600/JNE.png" width="100" alt="">
                                ...
                                <a href="https://www.tiki.id/id/tracking" style="text-decoration: none">
                                    <div class="card text-center text-dark p-3" style="margin-inline: 10px; background-color: rgba(169, 169, 170, 0.514)"">
                                        <img src="https://www.tikibanjarmasin.com/images/Logo-TIKI.png" width="203" alt="">
                                        <p>Tracking JNE</p>
                                    </div>
                                </a>
                                <a href="https://www.posindonesia.co.id/id/tracking" style="text-decoration: none">
                                    <div class="card text-center text-dark p-3" style="margin-inline: 10px; background-color: rgba(169, 169, 170, 0.514)"">
                                        <img src="https://i0.wp.com/www.desaintasik.com/wp-content/uploads/2019/04/Logo-PT-Pos-Indonesia-png-vector-corel-draw-download-desaintasik.png?resize=328%2C225" width="110" alt="">
                                        <p>Tracking POS</p>
                                    </div>
                                </a>
                            </div>
