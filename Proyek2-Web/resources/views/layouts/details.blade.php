...
<div>
    <input required type="email" class="form-control @error('email') is-invalid @enderror input-lg" name="email">
    @error('email')
...
<div class="modal-body">
    <form id="handleAjax" name="postForm" role="form" method="POST" action="/login">
        ...
        <div class="form-group">
            ...
            <div>
                <input required type="email" class="form-control @error('email') is-invalid @enderror input-lg"
                    name="email">
                @error('email')
                <div id="" class="invalid-feedback">
                    {{ $message }}
...
<div class="mb-3">
    <input type="text" name="alamat" class="form-control" id="exampleFormControlInput1" placeholder="* Alamat Lengkap "
        required>
</div>
<div class="mb-3">
