        ...
        <div class="detail-page">
            <div class="container">
                        ...
                        <div class="desc col-lg-5 ms-lg-5">
                            ...
                            <div class="quantity buttons_added mb-4">
                                ...
                                <input type="button" value="-" class="minus"><input required id="quan" type="number"
                                    onchange="calc()" step="1" min="1" max="100" name="quantity" value="1" title="Qty"
                            ...
                            @else
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-buy" data-bs-toggle="modal" data-bs-target="#login">Tambah ke
                                        keranjang <i class="bi bi-cart-check-fill fa-lg"></i></a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="handleAjax" name="postForm" role="form" method="POST"
                                                        action="/login">
                                                        @csrf
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <input required type="email"
                                                                    class="form-control @error('email') is-invalid @enderror input-lg"
                                                                    name="email">
                                                                @error('email')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <input required type="password"
                                                                    class="form-control @error('password') is-invalid @enderror input-lg"
                                                                    name="password">
                                                                @error('password')
                                                                    <div id="" class="invalid-feedback">
                                                                        {{ $message }}
                ...
                <div class="row mt-5 p-5 text-center" style="background-color: rgb(225, 225, 225)">
                    <div class="col-md-4">
                        <img src="{{ asset('/storage/' . $produk->featured_image) }}" alt="" width="300"
                            class="img-fluid">
                    </div>
                    <div class="col-md-4">
                        <img src="{{ asset('/storage/' . $produk->featured_image) }}" alt="" width="300"
