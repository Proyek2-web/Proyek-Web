            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="row mt-3">
                                    <div class=" col-12">
                                        <input type="number" name="nomor_hp" class="form-control" id="exampleFormControlInput1"
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 ">
                                        <input type="number" name="zip_code" class="form-control" id="exampleFormControlInput1"
                        ...
                        <button id="btn-check" class="btn btn-conf">Konfirmasi</button>
                    ...
                    <div class="total d-flex justify-content-between">
                        <h5>Total</h5>
                        <h5 id="total_checkout">Rp. {{ number_format($subtotal, 2) }}</h5>
                    </div>
                    <div class="d-flex mt-5 justify-content-center">
                        <input type="hidden" name="sub_total" value="{{ $subtotal }}">
                        <input type="hidden" name="total_ongkir">
                        <input type="hidden" name="total">
                        <button type="submit" id="checkout-button" class="btn btn-conf d-none">CHECKOUT<i class="bi bi-check-circle-fill"></i></button>
                    </div>
                    {{-- <div class="d-flex mt-5 justify-content-center">
                    ...
                    if (response) {
                        ...
                        $.each(response[0]['costs'], function(key, value) {
                            $('#ongkir').append('<li class="list-group-item">' +
                                ...
                                ' (' + value.cost[0].etd + ') hari + (7) hari produksi</li>')
                        });
                    }
                }
            });
