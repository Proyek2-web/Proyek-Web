                ...
                <div class="row justify-content-center">
                            ...
                            <div class="row g-0 align-items-center text-center">
                                <div class="col-md-4">
                                    <img src="cover_product/{{ $d->featured_image }}" class="img-fluid"  alt="..."
                                        style="border-radius: 20px; height: 170px">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-dark"><small
                                                ...
                                                : {{ $d->qty }}</small></p>
                                        <p class="card-text text-dark"><small
                                                style="border-radius: 5px; padding-inline: 15px; padding-block: 5px; background-color: #d2d2d2b9">
                                                {{ $d->status_produk }}</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7 p-5"
                        ...
                        <div class="row p-4 text-light">
                            ...
                            <div class="card text-dark mb-2 ms-2" style="background-color: #f4f1de;">
                                <h5 class="card-header"  style="font-family: PT Serif"><i class="bi bi-geo-alt-fill"></i> Alamat Pengiriman</h5>
                                <div class="card-body">
                                    @php
                                    ...
                                    @endphp
                                    <p class="card-text">{{ $a->user->name }} | {{ $a->no_telepon }} <br>
                                        {{ $a->alamat }} <br> {{ $kota }}, {{ $prop }}, ID {{ $a->zip_code }} </p>
                                </div>
                            </div>
                            ...
                            <input class='input-field ' type="text"
                                placeholder="{{ $d->nama }} : {{ $d->catatan != null ? $d->catatan : '-' }}" disabled
