    ...
    <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="our_solution_category">
                        <div class="solution_cards_box">
                            @forelse ($order as $o)
                            <div class="solution_card mt-4 p-3 mb-4">
                                <div class="hover_color_bubble"></div>
                                <div class="d-flex align-items-center">
                                    <div class="so_top_icon mt-2">
                                    ...
                                    <p class="ms-3 mt-3">{{ $o->merchant_ref }} </p>
                                </div>
                                <div class="solu_title">
                                    <h3 style="font-weight: bold">{{ $o->nama }} </h3>
                                </div>
                                <div class="solu_description">
                                    <form action="{{ route('transaction.show', $o->id) }}" method="GET">
                                        <p style="font-style: italic; color: rgb(181, 182, 182)">
                                            {{ date(' l, j\\-F-Y / H:i a', strtotime($o->created_at)) }}</p>
                                        @if ($o->status == 'PAID' && $status)
                                        <input type="hidden" name="status" value="1">
                                        <div class="col-md-2">
                                            <div class="alert alert-success d-flex align-items-center justify-content-center"
                                                role="alert" style="height: 20px; border-radius: 40px">
                                                <i class="bi bi-exclamation-circle-fill me-1 "></i>
                                                {{ $o->status }}
                                            </div>
                                        </div>
                                        <button type="submit" class="read_more_btn">Lacak</button>
                                        ...
                                        <button type="submit" class="read_more_btn">Lihat detail</button>
                                        @else
                                        <div class="col-md-2">
                                        ...
                                        <button type="submit" class="read_more_btn">Bayar </button>
                                        @endif
                                </div>
                            </div>
                            @empty
        ...
        <a style="text-decoration: none;color: black;">
            <div class="col-md-12 mt-5">
                <a href="{{ route('transaction.show', $o->id) }}">
